...
-- AddForeignKey
ALTER TABLE "courses_modules" ADD CONSTRAINT "courses_modules_model_id_fkey" FOREIGN KEY ("model_id") REFERENCES "modules"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
